...
# Defining s1, s2, s3
s <- c(10, 25, 30)
# Defining our observed y
y <- my.sim.X(D, "matern", c(5, 20), 3, 1)[s, "Value"]

# Function that calculates the covariance matrix of Y
...
# Function that calculates the conditional mean of X given Y
...
# Function that calculates the conditional covariance matrix of X given Y
...
# Function that plots the conditional mean and 90% prediction interval of X given Y
...
```{r}
# Function that simulates X given Y
...
# Function that calculates the empirical conditional mean and 90% prediction interval of X given Y
...
# Function that plots the empirical conditional mean and 90% prediction interval of X given Y
...
```{r}
# Function that calculates A hat
...
# Function that calculates A tilde
...
# Function that plots kriging predictions
...
# Function that plots kriging variances
...
```{r}
# Function that calculates the empirical semivariogram for k random locations and the true semivariogram and plots it
...
# Function that plots the empirical for MLE for k random locations and true semi-variance for a realization of the spatial process
