...
sim_N_cond_M <- function(counts, probabilities, seed) {
  ...
  df$sim_N <- df$sim_N + counts$N_obs
...
sim_500_N_sd_plot <- ggplot(sim_500_N) +
  ...
  coord_fixed() +
  scale_fill_viridis_c("Priori \nstandard deviation", limits = c(0.3, 1.3)) +
  labs(x = "x", y = "y") +
  theme(axis.text = element_text(size = 15, margin = unit(0.5, "cm")),
        axis.title = element_text(size = 18),
        plot.title = element_text(size = 20),
...
sim_500_N_cond_M_mean_plot <- ggplot(sim_500_N_cond_M) +
  geom_tile(aes(x, y, fill = avg_sim_N)) +
  coord_fixed() +
  scale_fill_viridis_c("Posteriori \nexpected value", option = "magma", limits = c(0.3, 3.6)) +
  labs(x = "x", y = "y") +
  theme(axis.text = element_text(size = 15, margin = unit(0.5, "cm")),
        axis.title = element_text(size = 18),
        plot.title = element_text(size = 20),
...
# ggsave("Figs/Problem 2/e/sim_500_N_mean_plot.png", sim_500_N_mean_plot, width = 6, height = 4)
# ggsave("Figs/Problem 2/e/sim_500_N_sd_plot.png", sim_500_N_sd_plot, width = 6, height = 4)
# ggsave("Figs/Problem 2/e/sim_500_N_cond_M_mean_plot.png", sim_500_N_cond_M_mean_plot, width = 6, height = 4)
# ggsave("Figs/Problem 2/e/sim_500_N_cond_M_sd_plot.png", sim_500_N_cond_M_sd_plot, width = 6, height = 4)
```
